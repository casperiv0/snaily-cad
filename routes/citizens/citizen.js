export function citizenPage(req, res, next) {
...
export function citizenDetailPage(req, res) {
    if (!req.session.loggedin) {
        res.redirect("/login")
    }
...
export function addCitizenPage(req, res) {
    if (!req.session.loggedin) {
        res.redirect("/login")
    }
...
export function addCitizen(req, res) {
    if (!req.session.loggedin) {
        res.redirect("/login")
    }
...
export function editCitizenPage(req, res) {
    if (!req.session.loggedin) {
        res.redirect("/login")
    }
    let genderQ = "SELECT * FROM `genders`"
...
export function editCitizen(req, res) {
    if (!req.session.loggedin) {
        res.redirect("/login")
    }
    let id = req.params.id
...
export function deleteCitizens(req, res) {
    if (!req.session.loggedin) {
        res.redirect("/login")
    }
